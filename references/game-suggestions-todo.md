...
|---|---|---|---|---|
| 2026-06-19 | Pong Duel | VERSUS | SUGERIDO | Puntaje perfecto 15/15: categoría VERSUS sub-representada, implementación trivial en canvas 2D, reconocimiento máximo como primer arcade comercial |
| 2026-06-19 | Minesweeper | PUZZLE | RECHAZADO | PUZZLE ya tiene Glot activo + Tetro comentado; menor urgencia que VERSUS |
...
| 2026-06-19 | Breakout Duel | VERSUS | SUGERIDO | 14/15 — física de bola reutilizable de bricks/game.ts + referencia arkanoid disponible; diferenciador real vs Pong con bloques y segunda paleta |
| 2026-06-19 | Air Hockey Duel | VERSUS | RECHAZADO | 13/15 — buena física pero ningún código de base reutilizable; mayor esfuerzo de implementación que Breakout Duel |
| 2026-06-19 | Tank Arena | VERSUS | RECHAZADO | 13/15 — reconocimiento clásico alto pero tile-map + colisiones de proyectil más complejo que alternativas |
| 2026-06-19 | Combat Jets | VERSUS | RECHAZADO | 12/15 — mecánica interesante pero físicas de vuelo (inercia/thrust) suben complejidad innecesariamente |
| 2026-06-19 | Sumo Ring | VERSUS | RECHAZADO | 12/15 — menor reconocimiento clásico arcade; mecánica de empuje menos legible en canvas que las otras opciones |
